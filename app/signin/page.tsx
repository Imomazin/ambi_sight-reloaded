...
export default function SignInPage() {
  ...
  const [oauthStep, setOauthStep] = useState<OAuthStep>(providerParam ? 'connecting' : 'select');
  ...
  useEffect(() => {
    if (providerParam) {
      ...
      // Simulate OAuth handshake delay then show account chooser
    ...
    <div className="min-h-screen bg-[var(--bg-primary)] flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-md">
          {/* OAuth Connecting Screen */}
          {oauthStep === 'connecting' && (authMethod === 'google' || authMethod === 'microsoft' || authMethod === 'github') ? (
              ...
              <div className="text-center">
                ...
                <div className="mb-6">
                  {authMethod === 'google' ? (
                    ...
                    <svg className="w-20 h-20 mx-auto" fill="#24292e" viewBox="0 0 24 24">
                ...
                <h2 className="text-xl font-medium text-gray-800 mb-2">
                  Connecting to {authMethod === 'google' ? 'Google' : authMethod === 'microsoft' ? 'Microsoft' : 'GitHub'}
                </h2>
          ...
          ) : oauthStep === 'choose_account' && (authMethod === 'google' || authMethod === 'microsoft' || authMethod === 'github') ? (
            /* OAuth Choose Account Screen - like real Google/Microsoft */
              ...
              <div className="p-6 pb-4 border-b border-gray-100">
                <div className="flex justify-center mb-4">
                  {authMethod === 'google' ? (
                    ...
                    <svg className="w-12 h-12" fill="#24292e" viewBox="0 0 24 24">
                      <path d="M12 2C6.477 2 2 6.477 2 12c0 4.42 2.87 8.17 6.84 9.5.5.08.66-.23.66-.5v-1.69c-2.77.6-3.36-1.34-3.36-1.34-.46-1.16-1.11-1.47-1.11-1.47-.91-.62.07-.6.07-.6 1 .07 1.53 1.03 1.53 1.03.87 1.52 2.34 1.07 2.91.83.09-.65.35-1.09.63-1.34-2.22-.25-4.55-1.11-4.55-4.92 0-1.11.38-2 1.03-2.71-.1-.25-.45-1.29.1-2.64 0 0 .84-.27 2.75 1.02.79-.22 1.65-.33 2.5-.33.85 0 1.71.11 2.5.33 1.91-1.29 2.75-1.02 2.75-1.02.55 1.35.2 2.39.1 2.64.65.71 1.03 1.6 1.03 2.71 0 3.82-2.34 4.66-4.57 4.91.36.31.69.92.69 1.85V21c0 .27.16.59.67.5C19.14 20.16 22 16.42 22 12A10 10 0 0012 2z"/>
                    </svg>
                  )}
                </div>
                <h2 className="text-xl font-normal text-center text-gray-800">
                  {mode === 'signin' ? 'Sign in' : 'Sign up'} with {authMethod === 'google' ? 'Google' : authMethod === 'microsoft' ? 'Microsoft' : 'GitHub'}
                </h2>
                <p className="text-sm text-gray-500 text-center mt-1">
                  to continue to <span className="text-gray-700">Lumina S</span>
                </p>
              </div>

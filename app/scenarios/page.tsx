          ...
          <div className="flex items-center gap-3">
            ...
            {currentScenario && (
              <button
                ...
                className="px-4 py-2 bg-navy-700 border border-navy-600 rounded-xl text-sm text-gray-300 hover:text-white hover:border-purple-400/50 transition-colors"
              >
        ...
        <div className="mb-8 p-4 bg-purple-500/10 border border-purple-500/30 rounded-xl">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="text-sm text-purple-400 font-medium">Active Scenario</span>

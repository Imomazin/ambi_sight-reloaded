    ...
    <div className="card card-hover group">
      ...
      <div className="flex items-center justify-between pt-4 border-t border-navy-600">
        ...
        <button
          ...
          className="px-4 py-2 text-sm font-medium text-purple-400 bg-purple-500/10 rounded-lg border border-purple-500/30 hover:bg-purple-500/20 transition-colors"
        >
          Open in Workspace →
        </button>
      </div>
      ...
      <div className="flex gap-4 mt-4 pt-4 border-t border-navy-600">
        ...
        <div className="text-center flex-1">
          ...
          <span className={`text-sm font-medium ${scenario.multipliers.volatility > 1 ? 'text-amber-400' : 'text-purple-400'}`}>

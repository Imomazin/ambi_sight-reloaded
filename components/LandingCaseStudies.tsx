    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-2xl max-h-[90vh] bg-navy-800 rounded-2xl border border-navy-600 shadow-2xl overflow-hidden">
        ...
        <div className="px-6 py-6 overflow-y-auto max-h-[60vh]">
          {/* Headline Metric */}
          <div className="mb-6 p-4 rounded-xl bg-gradient-to-r from-teal-500/10 to-purple-500/10 border border-teal-500/10">
          ...
          {/* Solution */}
          <div className="mb-6">
            <h3 className="text-sm font-semibold text-teal-500 uppercase tracking-wider mb-2">Solution</h3>
        ...
        <div className="px-6 py-4 border-t border-navy-600 bg-navy-800/50">
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={onClose}
              className="px-4 py-2 bg-teal-500/10 text-teal-500 text-sm font-medium rounded-lg hover:bg-teal-500/15 transition-colors"
            >
              Close
            </button>
          </div>
...
function CaseStudyCard({
  ...
  return (
    <button
      onClick={onClick}
      className="flex-shrink-0 w-[340px] rounded-xl bg-gradient-to-br from-navy-700/80 to-navy-800/90 border border-navy-600 hover:border-teal-500/15 transition-all duration-300 hover:scale-[1.02] hover:shadow-xl hover:shadow-teal-500/10 text-left group overflow-hidden"
    >
      {/* Image Banner */}
      ...
      <div className="p-4">
        {/* Title */}
        <h3 className="text-white font-semibold mb-2 group-hover:text-teal-500 transition-colors line-clamp-2">
          {study.title}
        </h3>
        ...
        {/* Headline Metric */}
        <div className="flex items-center justify-between">
          <div className="px-3 py-1.5 rounded-lg bg-gradient-to-r from-teal-500/10 to-purple-500/20 border border-teal-500/10">
        ...
        {/* Read More */}
        <div className="mt-3 flex items-center gap-1 text-xs text-teal-500 opacity-0 group-hover:opacity-100 transition-opacity">
    ...
    <div className="flex items-center gap-2 flex-wrap">
      {filters.map((filter) => {
        ...
        const colors = filter === 'All'
          ? { bg: 'bg-teal-500/10', text: 'text-teal-500', border: 'border-teal-500/15' }
    ...
    <section className="py-16 px-6 border-t border-navy-700 bg-gradient-to-b from-navy-800/30 to-transparent">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6 flex items-center justify-between">
          ...
          <span className={`text-xs ${isAutoScrolling ? 'text-teal-500' : 'text-gray-500'}`}>

    ...
    <div className="bg-navy-800/60 backdrop-blur-sm border border-navy-600/50 rounded-xl p-6 h-full">
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="text-right">
          <div className="text-2xl font-bold text-teal-500">{kpis.portfolioHealth}%</div>
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 mb-1">
                <span className="text-sm font-medium text-white truncate group-hover:text-teal-500 transition-colors">
                  {initiative.name}
                </span>
            ...
            {/* Arrow */}
            <svg className="w-4 h-4 text-gray-500 group-hover:text-teal-500 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      {/* View all link */}
      <button className="w-full mt-4 py-2 text-sm text-teal-500 hover:text-teal-300 transition-colors flex items-center justify-center gap-2">

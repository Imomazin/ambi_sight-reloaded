    ...
    <div className="bg-navy-800/60 backdrop-blur-sm border border-navy-600/50 rounded-xl p-6 h-full">
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="text-right">
          <div className="text-2xl font-bold text-purple-400">{kpis.portfolioHealth}%</div>
      ...
      {/* View all link */}
      <button className="w-full mt-4 py-2 text-sm text-purple-400 hover:text-purple-300 transition-colors flex items-center justify-center gap-2">

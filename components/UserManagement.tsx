      ...
      <div className="bg-navy-800 rounded-2xl border border-navy-600 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-navy-600">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-teal-500 to-purple-500 flex items-center justify-center text-white font-semibold">
              {editedUser.avatar}
            </div>
            <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2.5 bg-navy-700 border border-navy-600 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-teal-500"
              />
            </div>
            <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-2.5 bg-navy-700 border border-navy-600 rounded-lg text-white focus:outline-none focus:border-teal-500"
              >
      ...
      <div className="card p-4">
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <div className="flex-1">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 bg-navy-700 border border-navy-600 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-teal-500"
              />
            </div>
          </div>
          ...
          <select
            ...
            className="px-4 py-2.5 bg-navy-700 border border-navy-600 rounded-lg text-white focus:outline-none focus:border-teal-500"
          >
              ...
              {filteredUsers.map((user) => (
                ...
                >
                  <td className="py-4 px-4">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-teal-500 to-purple-500 flex items-center justify-center text-white font-medium text-sm">
                        {user.avatar}
                      </div>
                      <div>
